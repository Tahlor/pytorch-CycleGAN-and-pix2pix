...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSizeX', type=int, default=286, help='scale images to this size')
        parser.add_argument('--loadSizeY', type=int, default=286, help='scale images to this size')
        parser.add_argument('--fineSizeX', type=int, default=256, help='then crop to this size')
        parser.add_argument('--fineSizeY', type=int, default=256, help='then crop to this size')
        ...
        parser.add_argument('--step', type=str, default=None, help='which step # to load? set to latest to use latest cached model')
