...
# --results_dir
freq=200
python -u train.py --dataroot $data --name handwriting_cyclegan_BW_GT --model cycle_gan2 --display_id 0 --no_flip --loadSizeY 64 --fineSizeY 64 --fineSizeX 1280 --loadSizeX 1280 --display_freq $freq --update_html_freq $freq --save_latest_freq $freq --input_nc 1 --output_nc 1
